...
sections:
  - elementId: ''
    ...
    actions: []
    text: >+
      <div style="text-align: left"><p><span style="color: #7FFFD4; font-size:
      38px; font-weight: bold; text-shadow: 0.2px 0.2px 0.2px #4682B4;">
          SEJA BEM-VINDO!
      </span></p>

      <span style="font-size: 25px;">
          Eu sou <span style="font-size: 28px; font-weight: 700; color: #E6E6FA; font-weight: bold; text-shadow: 0.2px 0.2px 0.2px #4682B4;">Anita Machado</span>, Analista de Dados e Soluções Digitais.
      </span>

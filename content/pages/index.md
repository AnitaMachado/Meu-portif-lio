...
sections:
  - elementId: ''
    ...
    actions: []
    text: >+
      <div style="text-align: left"><span style="color: #800080; font-size:
      38px; font-weight: bold; text-shadow: 0.2px 0.2px 0.2px blue;">
          SEJA BEM-VINDO!
      </span>

      <div style="font-size: 28px;">
          Eu sou <span style="font-weight: 700; color: #800080; font-weight: bold; text-shadow: 0.2px 0.2px 0.2px blue;">Anita Machado</span>, Analista de Dados e Soluções Digitais.
      </div>
